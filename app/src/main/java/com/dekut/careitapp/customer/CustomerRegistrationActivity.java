...
import com.dekut.careitapp.models.Technician;
import com.dekut.careitapp.technician.TechnicianHomeActivity;
import com.dekut.careitapp.technician.TechnicianRegistrationActivity;
            ...
            firebaseAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()){
                        ...
                        Technician technician = new Technician(firstName,secondName,email,mobile,"");
                        if (uid != null){
